...
// This example adds filtering for businesses within a given geographical distance of a given point
// (e.g. "all asian restaurants within 50 miles of me").  It assumes that the "earthdistance"
// extension has been enabled on your postgres instance.
